...
-- #NOTE: RUN THIS COMMAND ONCE ONLY THEN DELETE IT IN THE FILE.
CREATE USER 'ses'@'localhost' IDENTIFIED BY 'FoW451kurO5O1uViY48ebIwEVAd3ti';
GRANT ALL PRIVILEGES ON `ses` TO 'ses'@'localhost';
FLUSH PRIVILEGES;
-- #END NOTE
